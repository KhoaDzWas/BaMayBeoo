...
--------------------------------------------------------------------
local Library = Update:Window("Bright Hub ","")
------------------------------------------
...
local WWeapons = Library:Tab("Vũ Khí","rbxassetid://11446859498")
...
local Devil Fruit = Library:Tab("Fruit+Esp","rbxassetid://11446965348")
...
Setting:Label("Thông Tin Được Cập Nhập Ở Discord")
        ...
        if _G.FastAttack then
            if typeof(xShadowx) == "table" then
                pcall(function()
                    ...
                    xShadowx.activeController.hitboxMagnitude = 300
...
Setting:Toggle("Tự Đông Click",false,function(value)
 _G.click = value
end)
...
Setting:Toggle("Bắn Tùm Lum :3 [ Booster FPS ]",_G.WhiteScreen,function(value)
...
Main:Toggle("Tự Động Biển 3",_G.Auto_Third_World,function(value)
...
Weapon:Seperator(" Long Trảo Thủ ")
...
Weapon:Seperator(" Thần Diệt Quyền ")
...
spawn(function()
 ...
 DevilFruit:Dropdown("Chọn Trái Ác Quỷ Ăn",FruitList,function(value)
  _G.SelectFruitEat = value
  end)
 
 DevilFruit:Toggle("Tự Động Eat Fruit",_G.AutoEatFruit,function(value)
 ...
 DevilFruit:Toggle("Tự Động Random Fruit",_G.Random_Auto,function(value)
 ...
 DevilFruit:Toggle("Tự Động Drop Fruit",_G.DropFruit,function(value)
  _G.DropFruit = value
  end)
 ...
 DevilFruit:Toggle("Tự Động Store Fruit",_G.AutoStoreFruit,function(value)
 ...
 DevilFruit:Toggle("Dịch Chuyển Trái Ác Quỷ Spawn",false,function(value)
 _G.Grabfruit = value
end)
...
if World2 then
	...
	DevilFruit:Toggle("ESP Trái Cây",false,function(a)
		DevilFruitESP = a
 ...
 Shop:Button("Mua Haki Vũ Trang",function()
 ...
 Shop:Button("Buy Haki Quan Sát",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
  end)
 
 Shop:Seperator(" SHOP CẬN CHIẾN ")
 
 Shop:Button("Mua Chân Lửa Của Chân Giữa V1",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
  end)
 
 Shop:Button("Mua Võ Điện V1",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
  end)
 
 Shop:Button("Mua Karate Người Cá V1",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
  end)
 
 Shop:Button("Mua Long Trảo Thù V1",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
  end)
 
 Shop:Button("Mua Súp Bò Human",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
  end)
 ...
 Shop:Button("Mua Karate Người Cá V2",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
  end)
 
 Shop:Button("Mua Võ Điện V2",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
  end)
 
 Shop:Button("Mua Long Trảo Thủ V2",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
  end)
 Shop:Button("Mua Thần Diệt Quyền",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
  end)
 -----Shop----------------
 ...
 Shop:Button("Ná Kabucha",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Slingshot","1")
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Slingshot","2")
 end)
 
 Shop:Button("Đổi Tộc",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,3)
 end)
 
 Misc:Seperator(" Joins ")
 
 Misc:Button("Chọn Team",function()
 		local args = {
			[1] = "SetTeam",
			[2] = "Hải Tặc"
		}
...
Misc:Button("Shop Trái Ác Quỷ",function()
 local args = {
			[1] = "GetFruits"
		}
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Misc:Button("Danh Hiệu",function()
 local args = {
			[1] = "getTitles"
		}
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Misc:Seperator(" Player Misc ")
    ...
    Misc:Button("Đổi Dạng Haki",function()
...
Misc:Toggle("Đi Xuyên Tường",_G.No_clip,function(value)
 _G.No_clip = value
end)
...
Misc:Toggle("Dodge No Cooldown",false,function(value)
    ...
    Misc:Toggle("Auto Bật Tộc",_G.AutoAgility,function(value)
    ...
    Misc:Toggle("Tộc Thỏ Vĩnh Viễn",false,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    Misc:Toggle("Haki Quan Sát Vĩnh Viễn",getgenv().InfiniteObRange,function(value)
    ...
    Misc:Toggle("Geppo Vĩnh Viễn",getgenv().InfGeppo,function(value)
    ...
    Misc:Toggle("Tốc Biến Như Siêu Nhân",getgenv().InfSoru,function(value)
    ...
    Misc:Toggle("Lướt Trên Mặt Nước ",true,function(value)
        _G.WalkWater = value
    end)
    
    if World2 then
		Misc:Button("Xóa Dung nham",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
				if v.Name == "Lava" then   
					v:Destroy()
				end
...
local Dragon_Trident = Op:Label("❌: Đinh Ba Rồng")
local Yama = Op:Label("❌: Yama")
local Buddy_Sword = Op:Label("❌: Buddy Sword")
local Canvander = Op:Label("❌: Florentino")
local Twin_Hooks = Op:Label("❌: Song Móc")
local Spikey_Trident = Op:Label("❌: Đinh Ba Gai")
local Hallow_Scythe = Op:Label("❌: Lưỡi Hái")
local Dark_Dagger = Op:Label("❌: Yoru Mini")
        ...
        pcall(function()
            for i,v in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")) do
                ...
                if v.Name == "Dragon Trident" then
                    Dragon_Trident:Set("✅: Đinh Ba Rồng")
                end
                if v.Name == "Yama" then
                    Yama:Set("✅: Yama")
                end
                ...
                if v.Name == "Canvander" then
                    Canvander:Set("✅: Florentino")
                end
                if v.Name == "Twin Hooks" then
                    Twin_Hooks:Set("✅: Song Móc")
                end
                if v.Name == "Spikey Trident" then
                    Spikey_Trident:Set("✅: Đinh Ba Gai")
                end
                if v.Name == "Hallow Scythe" then
                    Hallow_Scythe:Set("✅: Lưỡi Hái ")
                end
                if v.Name == "Dark Dagger" then
                    Dark_Dagger:Set("✅: Yoru Mini")
                end
...
spawn(function()
    while task.wait() do
        ...
        if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess == nil then
            ...
            Don_Swan_Quest:Set("✅: Nhiệm vụ Doflamingo")
        end

        if game:GetService("ReplicatedStorage").Remotes["CommF_"]:InvokeServer("ZQuestProgress", "Check") == 1 then
            Kill_Don_Swan:Set("✅: Giết Doflamingo")
        end
    end
end)
...
local True_Triple_Katana = Op:Label("❌: Tam Bảo Kiếm")
        ...
        pcall(function()
            for i,v in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")) do
                ...
                if v.Name == "True Triple Katana" then
                    True_Triple_Katana:Set("✅: Tam Bảo Kiếm")
                end
            end
        end)
    end
...
local Superhuman = Op:Label("❌: Súp Bò Human")
local Death_Step = Op:Label("❌: Chân Lửa Của Chân Giữa")
local Sharkman_Karate = Op:Label("❌: Karate Người Cá V2")
local Electric_Claw = Op:Label("❌: Võ Điện V2")
local Dragon_Talon = Op:Label("❌: Long Trảo Thủ")
local God_Human = Op:Label("❌: Thần Diệt Quyền")

spawn(function()
    while task.wait() do
        if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
            Superhuman:Set("✅: Súp Bò Human")
        end
        if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep",true) == 1 then
            Death_Step:Set("✅: Chân Lửa Của Chân Giữa")
        end
        if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true) == 1 then
            Sharkman_Karate:Set("✅: Karate Người Cá V2")
        end
        if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw",true) == 1 then
            Electric_Claw:Set("✅: Võ Điện V2")
        end
        if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon",true) == 1 then
            Dragon_Talon:Set("✅: Long Trảo Thủ")
        end
    end
end)
...
local Kabu_cha = Op:Label("❌: Ná Kabucha")
local Acidum_Rifle = Op:Label("❌: Súng Độc")
local Bizarre_Rifle = Op:Label("❌: AK Rồng Xanh")
        ...
        pcall(function()
            for i,v in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")) do
                if v.Name == "Kabucha" then
                    Kabu_cha:Set("✅: Ná Kabucha")
                end
                if v.Name == "Acidum Rifle" then
                    Acidum_Rifle:Set("✅: Súng Độc")
                end
                if v.Name == "Bizarre Rifle" then
                    Bizarre_Rifle:Set("✅: AK Rồng Xanh")
                end
            end
        end)
    end
...
local Dark_Coat = Op:Label("❌: Áo Choàng Bóng Tối")
local Ghoul_Mask = Op:Label("❌: Mặt Nạ Quỷ")
local Swan_Glass = Op:Label("❌: Mắt Kính Doflamingo")
local Pale_Scarf = Op:Label("❌: Khăn Che KataKuri")
local Valkyrie_Helm = Op:Label("❌: Mũ Admin")
...
spawn(function()
    while task.wait() do
        pcall(function()
            for i,v in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")) do
                if v.Name == "Saber" then
                    Dark_Coat:Set("✅: Áo Choàng Bóng Tối")
                end
                if v.Name == "Ghoul Mask" then
                    Ghoul_Mask:Set("✅: Mặt Nạ Quỷ")
                end
                if v.Name == "Swan Glasses" then
                    Swan_Glass:Set("✅: Mắt Kính Doflamingo")
                end
                if v.Name == "Pale Scarf" then
                    Pale_Scarf:Set("✅: Khăn Che KataKuri")
                end
                if v.Name == "Valkyrie Helmet" then
                    Valkyrie_Helm:Set("✅: Mũ Admin")
                end
            end
        end)
    end
